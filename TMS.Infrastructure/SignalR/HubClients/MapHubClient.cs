...
internal sealed class MapHubClient(ILogger<MapHubClient> logger, IConfiguration configuration) : HubClientBase(logger, _activitySource), IMapHubClient 
{
    ...
    protected override void RegisterHandlers(HubConnection connection)
    {
        ...
        connection.On<IEnumerable<MapLinesDTO>>("MapLinesLoaded", line =>
        {
